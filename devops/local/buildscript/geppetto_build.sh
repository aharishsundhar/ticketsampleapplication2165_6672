...
APPLICATION='/ticketsampleapplication2165'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication2165-desktop:1.0'
...
helm install --name ticketsampleapplication2165-6672 ./helm
if [ $? -eq 0 ]; then
